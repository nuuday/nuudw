/*
Deployment script for POFerriesDW
...
GO
:setvar DatabaseName "POFerriesDW"
:setvar DefaultFilePrefix "POFerriesDW"
...
GO
EXECUTE sp_addextendedproperty @name = N'DatabaseNameDW', @value = N'POFerriesDW';
...
GO
EXECUTE sp_addextendedproperty @name = N'DatabaseNameHistory', @value = N'POFerriesDW';
...
GO
EXECUTE sp_addextendedproperty @name = N'DatabaseNameMeta', @value = N'POFerriesDW';
...
GO
EXECUTE sp_addextendedproperty @name = N'DatabaseNameStage', @value = N'POFerriesDW';
...
GO
EXECUTE sp_addextendedproperty @name = N'DatabaseNameTabular', @value = N'POFerriesDW';
