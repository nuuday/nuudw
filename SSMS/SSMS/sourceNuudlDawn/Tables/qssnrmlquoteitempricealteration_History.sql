CREATE TABLE [sourceNuudlDawn].[qssnrmlquoteitempricealteration_History] (
    ...
    CONSTRAINT [PK_qssnrmlquoteitempricealteration_History] PRIMARY KEY NONCLUSTERED ([NUUDL_ID] ASC, [DWValidFromDate] ASC)
);
...
GO
CREATE NONCLUSTERED INDEX [NCIX_qssnrmlquoteitempricealteration_History__quote_id_quote_version_quote_item_id_price_type_price_alteration_type]
    ON [sourceNuudlDawn].[qssnrmlquoteitempricealteration_History]([DWIsCurrent] ASC, [NUUDL_IsCurrent] ASC, [quote_id] ASC, [quote_version] ASC, [quote_item_id] ASC, [price_type] ASC, [price_alteration_type] ASC);


GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_qssnrmlquoteitempricealteration_History]
    ON [sourceNuudlDawn].[qssnrmlquoteitempricealteration_History];
