CREATE TABLE [sourceNuudlNetCracker].[orgchartteam] (
    [id]                                                   NVARCHAR (36)  NULL,
    ...
    CONSTRAINT [PK_orgchartteam] PRIMARY KEY NONCLUSTERED ([NUUDL_ID] ASC)
);


GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_orgchartteam]
    ON [sourceNuudlNetCracker].[orgchartteam];
