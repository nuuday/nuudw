CREATE TABLE [sourceNuudlNetCracker].[riphonenumber_History] (
    ...
    CONSTRAINT [PK_riphonenumber_History] PRIMARY KEY NONCLUSTERED ([NUUDL_ID] ASC, [DWValidFromDate] ASC)
);


GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_riphonenumber_History]
    ON [sourceNuudlNetCracker].[riphonenumber_History];
