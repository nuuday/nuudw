CREATE TABLE [sourceNuudlNetCracker].[orgchartteammember_History] (
    [id]                                                   NVARCHAR (36)  NULL,
    ...
    CONSTRAINT [PK_orgchartteammember_History] PRIMARY KEY NONCLUSTERED ([NUUDL_ID] ASC, [DWValidFromDate] ASC)
);


GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_orgchartteammember_History]
    ON [sourceNuudlNetCracker].[orgchartteammember_History];
