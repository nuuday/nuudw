CREATE TABLE [sourceNuudlNetCracker].[pimnrmlproductoffering_History] (
    ...
    CONSTRAINT [PK_pimnrmlproductoffering_History] PRIMARY KEY NONCLUSTERED ([NUUDL_ID] ASC, [DWValidFromDate] ASC)
);


GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_pimnrmlproductoffering_History]
    ON [sourceNuudlNetCracker].[pimnrmlproductoffering_History];
