...
CREATE VIEW youseeassistedchannelsView.ActiveCustomers
AS
...
WITH subscriptions AS (
	...
	WHERE 1=1
		...
		AND pr.ProductType IN ('Mobile Voice','Mobile Broadband')
	GROUP BY
		cu.CustomerKey,
		ba.BillingAccountKey,
		pr.ProductType
...
SELECT 
	...
	MAX(CASE WHEN ProductType = 'Mobile Broadband' THEN 1 ELSE 0 END) MBB,
	MAX(CASE WHEN ProductType = 'Mobile Voice' THEN 1 ELSE 0 END) MV,	
	CAST(null as int) TV
