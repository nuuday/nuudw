...
SELECT 
	@CreateColumns = STRING_AGG(@CRLF+CHAR(9)+'[' + CASE WHEN LEFT(ColumnName,2) = 'DW' THEN 'SRC_' ELSE '' END + ColumnName + '] ' + FullDataTypeName + ' ' + NullableName, ',') WITHIN GROUP (ORDER BY OrdinalPositionNumber),
